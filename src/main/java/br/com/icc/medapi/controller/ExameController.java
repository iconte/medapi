...
public class ExameController {
	...
	@GetMapping
	public ResponseEntity<Map<String, Object>> listarTodos(@RequestParam(name = "page", defaultValue = "0") int page,
			@RequestParam(name = "size", defaultValue = "10") int size) {

		Page<ExameDTO> resultado = service.listarTodos(page, size);

		if (resultado == null || resultado.isEmpty()) {
			return new ResponseEntity<>(getRetornoSimplificado(resultado), HttpStatus.NOT_FOUND);
		}
	...
	public ResponseEntity<Map<String, Object>> listarPorCategoria(@PathVariable("id") Long categoriaExameId,
	...
	private Map<String, Object> getRetornoSimplificado(Page<ExameDTO> page) {
